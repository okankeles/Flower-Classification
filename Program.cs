...
namespace Cicek_Siniflandirma
{
    ...
    class NeuralNetwork
    {
        ...
        public void onaBol() //input seti 0-1 aralığında ölçeklendiriliyor
        {
            for (int i = 0; i < 150; i++)
            {
                for (int j = 0; j < 4; j++)
        ...
        public double[] slice(double[,] original, int index) //input ve weightlerin bulunduğu iki boyutlu arraylerin bir satırını alabilmek için
        {
